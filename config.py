...
SEED_SYMBOLS = [
    ...
    "SC/USDT","OKB/USDT","HBAR/USDT","EGLD/USDT","ALGO/USDT","CTC/USDT","THETA/USDT","KAVA/USDT","XTZ/USDT","ZIL/USDT",
    "NEO/USDT","QTUM/USDT","IOTA/USDT","ONDO/USDT","FXS/USDT","POL/USDT","RPL/USDT","ETHFI/USDT","PENDLE/USDT","ALT/USDT",
